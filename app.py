...
# Lokale Dateiordner auf dem Server absichern
...
# Textuelle Gedächtnis-Datenbank für unbeschönigte KI-Abend-Auswertungen
...
st.markdown(f"""
    ...
    h1, h2, h3, h4, h5, h6, p, span, label, div, th, td {{ color: {schrift_farbe} !important; }}
    ...
    .stTextInput>div>div>input {{ background-color: rgba(255,255,255,0.1) !important; color: {schrift_farbe} !important; }}
    .stNumberInput>div>div>input {{ background-color: rgba(255,255,255,0.1) !important; color: {schrift_farbe} !important; }}
    </style>
